%2019 Electric Car Accelleration Run Motor Simulation
%Started: 3/5/17
...
vehicleProfile = uigetfile('','Load Vehcile Profile','*.mat');
load(vehicleProfile)
...
TSCurveFile = uigetfile('','Slect Motor Torque vs Speed Curve','*.csv');  
motor = csvread(TSCurveFile);
